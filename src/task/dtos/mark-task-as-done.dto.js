...
/**
 * Data transfer object (DTO) for marking a task as 'done'.
 * Encapsulates validation and parsing of CLI arguments
 * related to marking a task as 'done'.
 */
export class MarkTaskAsDoneDto {
  /**
  ...
  /**
   * Initializes a new MarkTaskAsDoneDto from CLI arguments.
   *
