...
describe('MarkTaskAsDoneDto', () => {
  describe('constructor', () => {
    it('should throw a RangeError if more than one argument is provided', async () => {
      ...
      await rejects(
        async () => new MarkTaskAsDoneDto(id, id),
        {
          name: 'RangeError',
  ...
  describe('id', () => {
    it('should be of type number', () => {
      const id = TestUtils.generateRandomInt().toString();
      const dto = new MarkTaskAsDoneDto(id);
