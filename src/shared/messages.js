export const messages = {
  error: {
    ...
    INVALID_TABLE_DATA_ROWS_BUFFER_LENGTH: 'Invalid length for table data rows buffer. Must be equal to the number of table data rows widths.',
    INVALID_TABLE_ROW_BUFFER_TYPE: 'Invalid type for table row buffer. Must be an array.',
    ...
    REQUIRED_TABLE_DATA_ROWS_BUFFER: 'Table data rows must contain buffer.',
