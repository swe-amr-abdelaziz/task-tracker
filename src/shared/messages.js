export const messages = {
  error: {
    ...
    ARGS_ALIASES_NOT_MATCHIING_VALID_ARGS: 'Invalid aliases. Aliases must match valid args.',
    ...
    CONFLICTING_ORDER_DIRECTIONS: 'Conflicting order directions provided. Only one direction can be used at a time.',
    DUPLICATE_CLI_ARG: 'Duplicate CLI argument "{0}".',
    DUPLICATE_HEADER_DATA_ROW_KEY: 'Duplicate key for responsive table header data row is not allowed.',
    EMPTY_CLI_ARG_KEY: 'CLI argument key cannot be empty.',
    EMPTY_CLI_ARG_VALUE: 'CLI argument value cannot be empty.',
    INVALID_ARGS_ALIASES_TYPE: 'Invalid type for aliases. Must be an object.',
    INVALID_ARGS_TYPE: 'Invalid type for args. Must be an array of strings.',
    INVALID_CLI_ARG: 'Invalid CLI argument "{0}".',
    INVALID_CREATED_AFTER_ARG_TYPE: 'Invalid type for createdAfter argument. Must be a valid date.',
    INVALID_CREATED_BEFORE_ARG_TYPE: 'Invalid type for createdBefore argument. Must be a valid date.',
    INVALID_DESCRIPTION_REGEX: 'Invalid regular expression for description.',
    INVALID_HELP_COMMAND: 'Invalid command for help page. "help" cannot be used as a help command.',
    INVALID_ID_ARG_TYPE: 'Invalid type for id argument. Must be a number.',
    ...
    INVALID_ORDER_BY_ARG_TYPE: 'Invalid type for orderBy argument. Must be a valid column name.',
    INVALID_PAGE_ARG_TYPE: 'Invalid type for page argument. Must be a number.',
    INVALID_PAGE_LIMIT_ARG_TYPE: 'Invalid type for page limit argument. Must be a number.',
    ...
    INVALID_STATUS_ARG_TYPE: 'Invalid type for status argument. Must be a valid status.',
    ...
    INVALID_UPDATED_AFTER_ARG_TYPE: 'Invalid type for updatedAfter argument. Must be a valid date.',
    INVALID_UPDATED_BEFORE_ARG_TYPE: 'Invalid type for updatedBefore argument. Must be a valid date.',
    INVALID_VALID_ARGS_TYPE: 'Required validArgs argument is missing.',
    ...
    PAGE_LIMIT_OUT_OF_RANGE: 'Page limit must be greater than or equal to 0.',
    PAGE_NUMBER_OUT_OF_RANGE: 'Page number must be greater than or equal to 1.',
    PAGE_WITH_UNLIMITED_LIMIT: 'Page number must equal 1 with unlimited limit.',
    READ_DB_FAILED: 'Failed to read database file.',
    REQUIRD_TABLE_ROW_WIDTH: 'Table row width is required.',
    REQUIRED_ARGS: 'Required args argument is missing.',
    ...
    REQUIRED_VALID_ARGS: 'Required validArgs argument is missing.',
